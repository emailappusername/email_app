...
app.layout = html.Div(
    children=[
        ...
        html.Div(
            children=[
                ...
                html.Div(
                    ...
                    #     dcc.RangeSlider(
                    #         id="amount-word-filter",
                    #         min = min(length_words), 
                    #         max = max(length_words), 
                    #         step = 5, 
                    #         value = [0,10], 
        ...
        # word slider as it is quite large based on words available
        html.Div(
            children=[
                  html.Div(
                    # children=[
                    ...
                    # ],
                    children=[
                        html.Div(children="Range of Words", className="menu-title"),
                        dcc.RangeSlider(
                            id="amount-word-filter",
                            min = min(length_words), 
                            max = max(length_words), 
...
def update_word_chart(amount, start_date, end_date, radio_button_select): 
    ...
    filtered_data = filtered_data[amount[0]:amount[1]]
